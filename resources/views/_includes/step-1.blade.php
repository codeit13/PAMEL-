      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12 d-flex-row">
          ...
          <div class="form-group">
            ...
            <input id="lesson-case-date" type="date" required="required" class="form-control">
          </div>
          <div class="form-group">
            <label class="control-label">Lesson Start Time</label>
            <input id="lesson-case-start-time" type="time" required="required" class="form-control">
          </div>
          <div class="form-group">
            <label class="control-label">Lesson End Time</label>
            <input id="lesson-case-end-time" type="time" required="required" class="form-control">
          </div>
