        ...
        <div class="col-md-12">
            <div class="d-flex flex-row align-items-center mb-4">
                ...
                <div class="d-flex flex-row-reverse" style="flex: auto">
                    <div class="">
                        <a @click="addMoreDataSources" class="btn btn-primary">Add New Data Source</a>
                    </div>
                    <div class="">
                        <input type="number" v-model="addMoreDataSourcesCount" class="form-control">
                    </div>
                </div>
            </div>
            <!-- Starts here -->
            <div v-for="dataSource in config.dataSources.data" class="d-flex">
                <div class="form-group">
                    <label class="control-label">DS Name</label>
                    <input type="text" v-model="config.dataSources.data[(dataSource.id-1)].name" class="form-control">
                </div>
                <div class="form-group">
                    <label class="control-label">DS Type</label>
                    <select v-model="config.dataSources.data[(dataSource.id-1)].dataSourceType" class="form-control">
                        <option disabled selected>Choose</option>
                        <option value="Google Form">Google Form</option>
                        <option value="OpenSpace Video">Open Space Video</option>
                        <option value="Graasp">Graasp</option>
                    </select>
                </div>
                <div class="form-group">
                    <label class="control-label">Activity Type</label>
                    <select v-model="config.dataSources.data[(dataSource.id-1)].activityType" class="form-control">
                        <option disabled selected>Choose</option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" v-model="config.dataSources.data[(dataSource.id-1)].frequency" class="form-control" min="1"
                        max="5">
                </div>
                <div class="form-group">
                    <label class="control-label pl-4">Timezone</label>
                    <select v-model="config.dataSources.data[(dataSource.id-1)].timezone" class="form-control">
                        <option disabled selected>Choose</option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" v-model="config.dataSources.data[(dataSource.id-1)].dataFiles" class="form-control">
                </div>
                <div class="form-group">
                    <label class="control-label">File Relation</label>
                    <select v-model="config.dataSources.data[(dataSource.id-1)].fileRelation" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select v-model="config.dataSources.data[(dataSource.id-1)].sourceType" class="form-control">
                        <option value="API" disabled>API</option>
                        <option value="G Drive">Gdrive</option>
                        <option value="Local System" selected>Local System</option>
                    </select>
                </div>
